import { A as AstroError, bb as MissingSharp } from './sequence_BuFzwd2R.mjs';
import { b as baseService, p as parseQuality } from './generic_CGEQ71bU.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_05Oj4L0B.mjs').then(n => n.i)).default;
  } catch {
